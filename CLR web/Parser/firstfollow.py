...
# def main(production_list, ntl, nt_list, tl, t_list, pl=None, grammars=None):
def main(pl=None, grammars=None):
...
#(Format: "A->Y1Y2..Yn" {Yi - single char} OR "A->" {epsilon})''')
    ...
    if pl==None:
        ...
        for grammar in grammars:
            ...
            production_list.append(grammar.replace(' ', ''))
    ...
    # del production_list, nt_list,  t_list  
    # return pl, production_list, nt_list, t_list
    # del t_list, nt_list
    return 
# ------------------------------------------------------------------
